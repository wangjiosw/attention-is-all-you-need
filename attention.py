...
class SelfAttention(nn.Module):
    def __init__(self):
        ...
        self.WQ = nn.Parameter((torch.randn(512, 64)))
        self.WK = nn.Parameter((torch.randn(512, 64)))
        self.WV = nn.Parameter((torch.randn(512, 64)))
...
class MultiHeadedSelfAttention(nn.Module):
    def __init__(self):
        ...
        self.WO = nn.Parameter((torch.randn(64*8, 512)))
